          ...
          <div className="flex items-center space-x-4 ml-auto">
            ...
            {user && (
              <>
                ...
                <button
                  onClick={logout}
                  className="btn-secondary text-sm dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600"
                >
                  Logout
                </button>
              </>
            ...
            {/* Dark Mode Toggle (always at the end) */}
            <button
